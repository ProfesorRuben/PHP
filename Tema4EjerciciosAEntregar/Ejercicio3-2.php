...
<body>
    ...
    ?>
        ...
        ?>
            ...
            <a href="Ejercicio3-1.php?intentos=<?= $intentos ?>">
                <h3>VOLVER</h3>
            </a>
        <?php
        }
        ...
        <table border=1 cellspacing=0 cellpadding=0 bordercolor="red">
            <tr>
                <td><img src="<?php echo ($num == 1) ? "../imagen/1.jpg" : "../imagen/oculto.jpg" ?>"></td>
                <td><img src="<?php echo ($num == 2) ? "../imagen/2.jpg" : "../imagen/oculto.jpg" ?>"></td>
                <td><img src="<?php echo ($num == 3) ? "../imagen/3.jpg" : "../imagen/oculto.jpg" ?>"></td>
            </tr>
            <tr>
                <td><img src="<?php echo ($num == 4) ? "../imagen/4.jpg" : "../imagen/oculto.jpg" ?>"></td>
                <td><img src="<?php echo ($num == 5) ? "../imagen/5.jpg" : "../imagen/oculto.jpg" ?>"></td>
                <td><img src="<?php echo ($num == 6) ? "../imagen/6.jpg" : "../imagen/oculto.jpg" ?>"></td>
            </tr>
            <tr>
                <td><img src="<?php echo ($num == 7) ? "../imagen/7.jpg" : "../imagen/oculto.jpg" ?>"></td>
                <td><img src="<?php echo ($num == 8) ? "../imagen/8.jpg" : "../imagen/oculto.jpg" ?>"></td>
                <td><img src="<?php echo ($num == 9) ? "../imagen/9.jpg" : "../imagen/oculto.jpg" ?>"></td>
            </tr>
        </table>
    <?php
    }
